...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Memo::class, mappedBy="UserID")
     */
    private $memos;

    /**
     * @ORM\OneToMany(targetEntity=Base::class, mappedBy="UserID")
     */
    private $bases;

    /**
     * @ORM\OneToMany(targetEntity=Factuur::class, mappedBy="UserID")
     */
    private $factuurs;
